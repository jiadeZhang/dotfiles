...
"zjd"Plugin 'gmarik/vundle'
"zjd"Plugin 'scrooloose/syntastic'
...
" 插件管理
"zjd"Bundle "mattn/emmet-vim"
"zjd"Bundle 'mattn/webapi-vim'
"zjd"Bundle 'mattn/gist-vim'
"zjd"Bundle 'Lokaltog/vim-easymotion'
